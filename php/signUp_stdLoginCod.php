...
if(isset($_POST['register'])) {
    ...
    if($password != $confirm_password) {
        ...
        echo "<script>window.location.replace('../coordinator.htm');</script>"; // Redirect back to registration page
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            echo "<script>window.location.replace('../add_std.htm');</script>"; // Redirect back to registration page
            exit(); // Stop further execution
        }
    }
}
